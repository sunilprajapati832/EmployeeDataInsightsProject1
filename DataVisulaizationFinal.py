...
match b:
    ...
    case 6:
            ...
            match e:
                case 1:
                        column1 = input("You choose 'Bar Chart' then please enter first column name in between you want to see the graph \n")
                ...
                case 2:
                        column1 = input("You choose 'Line Chart' then please enter first numerical column name in between you want to see the graph \n")
